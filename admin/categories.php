...
<div class="grid grid-cols-6">
    ...
    <div class=" m-5 col-span-5 ">
        ...
        <form action="categories.php" method="post">
            <div class="mt-3">
                <label for="product-name" class="block text-sm font-medium leading-6 text-gray-900">Category Name</label>
            ...
            <input type="submit" name="submit" value="Add" class=" mt-3 text-white border-2 px-4 py-2 text-sm rounded-md bg-gray-700 hover:bg-gray-800 transition-all cursor-pointer	">
        </form>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                ...
                if(mysqli_num_rows($query_exe)>0){ 
                    foreach($query_exe as $item) { ?>
                     <tr>
                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 "><?=$item['cat_id']?></td>
