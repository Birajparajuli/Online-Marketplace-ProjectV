...
<div class="flex flex-grow flex-col overflow-y-auto border-r border-t border-gray-200 bg-white pt-5 pb-4  h-full
">
  
  <div class=" flex flex-grow flex-col">
    <nav class="flex-1 space-y-1 bg-white" aria-label="Sidebar">

      <a href="index.php" class="border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-3 py-2 text-sm font-medium border-l-4">
