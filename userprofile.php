...
<div class="grid lg:grid-cols-6 lg:px-20 py-5 px-5 gap-5 grid-cols-1">
    <div class="lg:border-r-2 col-span-2 flex items-center flex-col border-r-0 ">
        ...
        <p>Member Since: <?= date("j F Y", strtotime($user['created_at']))?></p>
        <a href="#" class="text-white border-2 border-gray-800 px-4 py-2 my-3 text-sm rounded-md bg-gray-800 hover:bg-white hover:border-grey-600 hover:text-gray-600 transition-all	">
...
<div class="flex gap-4 border-2 p-1 rounded-md mb-3">
            <div>
                ...
                <img src="./media/uploads/ad/<?=$item["image_1"]?>" alt=""  class=" w-40 h-28 rounded-md object-cover">
                </a>
            </div>
            ...
            <a href="#" title="Boost" class="text-green-700 border-b-[1px] pb-1">
                ...
                <a href="deleteproduct.php?id=<?= $item["ad_id"]?>"  title="Delete" class="text-red-900 border-b-[1px] pb-1">
                ...
                <a href="#"  title="Hide/Show" class=" ml-auto">
                    <i class="fa fa-eye"></i>
                </a>
